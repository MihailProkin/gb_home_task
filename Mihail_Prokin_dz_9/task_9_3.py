class Worker:
    ...
    def __init__(self, name: str, surname: str, position: str, income: dict = {'wage': 0.0, 'bonus': 1.0}) -> None:
        self.name = name
...
if __name__ == '__main__':
    position = Position('Miha', 'Prokin', 'Programmer', {'wage': 100, 'bonus': 1.5})

    position.name = 'Mihail'
